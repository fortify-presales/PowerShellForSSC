$TemplatePowerShellModule = 'PowerShellForSSC'
...
$pubFunctions = (
    'Add-SSCApplicationVersion',
    'Get-SSCApplication', 'Get-SSCApplications', 'Get-SSCApplicationId',
    'Get-SSCApplicationVersion', 'Get-SSCApplicationVersions', 'Get-SSCApplicationVersionId',
    'Get-SSCConfig', 'Get-SSCToken',
    'New-SSCApplicationObject', 'New-SSCApplicationVersionObject', 'New-SSCAttributeObject',
    'Remove-SSCApplicationVersion',
    'Send-SSCApi', 'Set-SSCConfig',
