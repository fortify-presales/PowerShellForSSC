...
FunctionsToExport = @('Add-SSCApplicationVersion', 'Get-SSCApplication', 
               'Get-SSCApplicationId', 'Get-SSCApplications', 
               'Get-SSCApplicationVersion', 'Get-SSCApplicationVersionId', 
               'Get-SSCApplicationVersions', 'Get-SSCConfig', 'Get-SSCToken',
               'Get-SSCScanCentralSASTJob', 'Get-SSCScanCentralSASTJobs',
               'Get-SSCApplicationVersionArtifacts',
                'Approve-SSCArtifacts',
